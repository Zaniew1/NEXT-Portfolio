    ...
    return <div className={styles.about} >
        <div className={styles.about__text}>
            <div className={styles.about__text__switch}>
                <p onClick={()=>setSwitchText(0)} className={`${styles.about__text__switch__item} ${switchText == 0 ? `${styles.about__text__switch__item__active}`: ""}`}>{t("home.one")}</p>
                <p onClick={()=>setSwitchText(1)} className={`${styles.about__text__switch__item} ${switchText == 1 ? `${styles.about__text__switch__item__active}`: ""}`}>{t("home.two")}</p>
                ...
                <SwipeableDiv onSwipeLeft={swipeLeft} onSwipeRight={swipeRight}>
                    <div className={`${styles.about__text__paragraph} ${switchText ==1? styles.about__text__paragraph__frombottom: styles.about__text__paragraph__hide}`}> 
                            <p className={styles.about__text__paragraph__text__highlighted}>
                                {t("home.two_text.header_one")}
                            </p>
                            <p className={styles.about__text__paragraph__text}>
                                {t("home.two_text.header_one_text")}
                            </p>
                            <p className={styles.about__text__paragraph__text__highlighted}>
                                {t("home.two_text.header_two")}
                            </p>
                            <p className={styles.about__text__paragraph__text}>
                                {t("home.two_text.header_two_text")}
                            </p>
                            <p className={styles.about__text__paragraph__text__highlighted}>
                                {t("home.two_text.header_three")}
                            </p>
                            <p className={styles.about__text__paragraph__text}>
                                {t("home.two_text.header_three_text")}
                            </p>
